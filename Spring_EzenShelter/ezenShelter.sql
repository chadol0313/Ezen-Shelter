...
insert into reply values(SEQ_reply_r_num.nextVal,sysdate,'반갑습니다 자주소통해요','hong',6);
insert into reply values(SEQ_reply_r_num.nextVal,sysdate,'고양이가 너무 예쁘네요','one',7);
